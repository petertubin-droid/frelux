...
begin
  ...
  values
    ...
    ('Forest Retreat','forest-retreat','Deep forest green balanced with warm off-white and a brass accent for a sophisticated mood.','Forest Green','#2C4A3E','Off-White','#EFEAE0','Brass','#C9A86A','White Trim','#FFFFFF','Ceiling White','#FCFCFA','Forest Door','#2C4A3E','{Bedroom,Study}','Modern Luxury','https://images.pexels.com/photos/1665571/pexels-photo-1665571.jpeg?auto=compress&cs=tinysrgb&w=1200',array[cat_bedroom,cat_luxury,cat_bold,cat_green],true,5,true,true,true,82,'Residential'),
