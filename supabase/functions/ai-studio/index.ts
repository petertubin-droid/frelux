...
const TOOL_SYSTEM_PROMPTS: Record<string, string> = {
  ...
  api_builder: 'You are an expert Deno/Supabase Edge Function developer. Generate Edge Functions with: proper CORS headers (Access-Control-Allow-Origin: *, etc.), OPTIONS preflight handling, input validation, try/catch error handling, JSON responses, and type safety. Use npm: prefixed imports.',
