...
export default function ColorDetail() {
  ...
  useSeo({
    ...
    description:
      color?.description ??
      "View this curated paint color combination with color codes, recommended rooms, and styling tips.",
  ...
  const swatches = [
    {
      label: "Main color",
      name: color.main_color_name,
      hex: color.main_color_code,
    },
    {
      label: "Secondary color",
      name: color.secondary_color_name,
      hex: color.secondary_color_code,
    },
    {
      label: "Accent color",
      name: color.accent_color_name,
      hex: color.accent_color_code,
    },
  ];
  const colorCats = categories.filter((c) =>
    (color.category_ids ?? []).includes(c.id),
  );
        ...
        <div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <Info
              ...
              value={(color.recommended_rooms ?? []).join(", ") || "N/A"}
            />
