        ...
        <div className="bg-brand-navy text-white">
          <div className="max-w-5xl mx-auto px-4 py-10">
            ...
            <p className="text-white/70 text-sm md:text-base">
              Strip, pad, and raft foundation sizing based on soil bearing
              capacity. BS 8004 simplified method.
            </p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="inline-flex rounded-lg border border-neutral-200 overflow-hidden">
                <button
                  ...
                  className={`px-3 py-1 text-xs font-medium ${measurementUnit === "m" ? "bg-brand-purple text-white" : "text-neutral-500"}`}
                >
                  m
                </button>
                <button
                  ...
                  className={`px-3 py-1 text-xs font-medium ${measurementUnit === "ft" ? "bg-brand-purple text-white" : "text-neutral-500"}`}
                >
                  ft
                </button>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="rounded-xl bg-brand-navy p-4 text-white">
                  ...
                  <p className="text-xl font-bold">
                    ...
                    <span className="text-sm text-white/60">kN/m²</span>
                  </p>
                </div>
                <div className="rounded-xl bg-brand-navy p-4 text-white">
