      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0"
                      />
                      {errors.roomLength && <p className="mt-1 text-xs text-red-500">{errors.roomLength}</p>}
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0"
                      />
                      {errors.roomWidth && <p className="mt-1 text-xs text-red-500">{errors.roomWidth}</p>}
                    </div>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0"
                      />
                      {errors.wallWidth && <p className="mt-1 text-xs text-red-500">{errors.wallWidth}</p>}
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateArea('wallCount', parseInt(e.target.value) || 1)}
                        placeholder="1"
                        min="1"
                      />
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0"
                    />
                    {errors.wallHeight && <p className="mt-1 text-xs text-red-500">{errors.wallHeight}</p>}
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateArea('doors', parseInt(e.target.value) || 0)}
                        placeholder="0"
                        min="0"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateArea('windows', parseInt(e.target.value) || 0)}
                        placeholder="0"
                        min="0"
                      />
                    </div>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-neutral-200 text-left text-xs text-neutral-500">
                        ...
                        <th className="pb-2 text-right font-medium">Qty Needed</th>
        ...
        {!loading && !result && finishTypes.length === 0 && !loadError && (
          <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700">
            ...
            <p className="mt-1 text-xs">No finish type data found in the database. Calculations will use built-in defaults. An administrator can add finish types in the admin panel.</p>
          </div>
        )}
      </div>
      <RelatedTools links={[
