...
export default function Achievements() {
  ...
  useSeo({
    ...
    description:
      "Track your FRELUX milestones and unlock badges as you use the platform.",
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <Link
        to="/"
        className="mb-6 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-brand-purple dark:text-muted-foreground dark:hover:text-brand-purple-lighter"
      >
      ...
      <div className="mb-8 rounded-2xl border border-border bg-card p-6 dark:border-white/5 dark:bg-card">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-3xl font-bold text-brand-purple dark:text-brand-purple-lighter">
            {progress}%
          </div>
        </div>
      ...
      {categories.map((cat) => {
        ...
        return (
          <div key={cat.id} className="mb-8">
            <h2 className={classNames("mb-4 text-lg font-bold", cat.color)}>
              {cat.label}
            </h2>
              ...
              {catAchievements.map((ach) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isUnlocked && (
                      <span className="rounded-full bg-amber-400 px-2 py-0.5 text-[10px] font-bold text-primary-foreground">
                        DONE
                      </span>
                    )}
                  </div>
