  ...
  return (
    <RequireOwner>
      <div className="archie-fade-up mx-auto max-w-2xl px-4 py-4 md:py-6">
        ...
        {error && (
          <p
            className="mt-3 rounded-md bg-red-500/10 px-3 py-2 text-xs text-red-300"
            role="alert"
          >
            {error}
          </p>
          ...
          <div className="mt-4 space-y-3">
            ...
            {needsSecret && (
              <p className="rounded-md bg-rose-500/10 px-3 py-2 text-[11px] text-rose-300">
                ...
                server-side for this run only — it is never stored on this
                device.
              </p>
            )}
            ...
            {outcome && (
              <div
                className="archie-panel rounded-lg p-3"
