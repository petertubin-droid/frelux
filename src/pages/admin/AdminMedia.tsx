                  ...
                  <div className="p-3">
                    {editingAlt === item.id ? (
                      <div className="flex items-center gap-2">
                        ...
                        <button type="button" onClick={() => setEditingAlt(null)} className="rounded-md border border-neutral-200 p-1.5 text-neutral-500"><X className="h-3.5 w-3.5" /></button>
                      </div>
                    ) : (
                    ...
                    {item.alt_text && editingAlt !== item.id && <p className="mt-0.5 truncate text-[10px] text-neutral-400">{item.alt_text}</p>}
                    <p className="mt-0.5 text-[10px] text-neutral-400">{(item.size_bytes / 1024).toFixed(0)} KB</p>
                  </div>
                </AdminCard>
              ))}
            </div>
