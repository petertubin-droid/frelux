    ...
    <>
      ...
      {loading ? (
        <StateMessage
          type="loading"
          title="Loading…"
          message="Fetching production rules."
        />
      ) : rules.length === 0 && !showForm ? (
        <StateMessage
          type="empty"
          title="No rules found"
          message="Add production rules to manage minimums."
        />
      ) : (
                ...
                <div className="space-y-2">
                  ...
                  {Object.entries(
                    ...
                    const qLabel =
                      qKey === "_all"
                        ? "All Qualities"
                        : (QUALITY_SLUGS.find((q) => q.value === qKey)?.label ??
                          qKey);
                    return (
                      <div
                        key={qKey}
...
function ProductionRuleForm({
  ...
  return (
    <AdminModal
      open
      onClose={onCancel}
      title={rule ? "Edit Rule" : "Add Production Rule"}
      maxWidth="max-w-md"
    >
      <div className="space-y-3">
        ...
        <AdminField
          label="Quality Level (optional)"
          hint="Leave as 'All Qualities' for a general minimum."
        >
          <AdminSelect
            value={qualitySlug}
        ...
        <AdminField
          ...
          hint="Set to 0 for no minimum (Owerri rule)."
        >
          <AdminInput
            type="number"
            value={minQuantity}
