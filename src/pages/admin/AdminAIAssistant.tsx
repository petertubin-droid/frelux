              ...
              {QUICK_TEMPLATES.map((template) => {
                ...
                return (
                  <Button
                    ...
                    className="flex h-auto items-center gap-3 rounded-xl border border-border p-4 text-left transition-all hover:border-brand-purple hover:bg-primary/5 dark:border-white/10 dark:hover:border-brand-purple/30"
                  >
