  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <AdminCard>
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">Global AI</h2>
              <div className="mt-3 flex items-center gap-3">
                <Toggle checked={settings.ai_enabled} onChange={(v) => update('ai_enabled', v)} />
                <div><p className="text-sm font-semibold text-neutral-700 dark:text-neutral-200">AI features enabled</p><p className="text-xs text-neutral-400 dark:text-neutral-500">Master switch for all Smart Color Assistant features.</p></div>
              </div>
            </div>
          </div>
        </AdminCard>
        ...
        {/* Access mode */}
        <AdminCard>
          <h2 className="mb-4 text-sm font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">Access Mode</h2>
          <div className="grid gap-3 sm:grid-cols-2">
            {ACCESS_MODES.map((m) => (
              ...
              >
                ...
                <span className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">{m.description}</span>
              </button>
            ))}
          </div>
        </AdminCard>
        ...
        {/* Daily usage */}
        <AdminCard>
          <h2 className="mb-4 text-sm font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">Shared Daily Usage</h2>
        ...
        {/* Paid access (future) */}
        <AdminCard>
          <div className="flex items-center gap-2"><CreditCard className="h-4 w-4 text-accent-green" /><h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">Paid Access</h2></div>
        ...
        {/* Admin override */}
        <AdminCard>
          <div className="flex items-center gap-2"><Lock className="h-4 w-4 text-brand-navy" /><h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">Admin Override</h2></div>
