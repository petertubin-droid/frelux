            ...
            <AdminCard key={feat.id} className="p-5">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-neutral-500">{feat.is_enabled ? 'Enabled' : 'Disabled'}</span>
                </div>
              </div>
              ...
              {/* Reward rules */}
              <div className="mt-4">
                <h4 className="mb-2 text-xs font-bold uppercase tracking-widest text-neutral-400">Reward Rules</h4>
          ...
          <AdminCard key={cfg.id} className="p-5">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-neutral-500">{cfg.is_enabled ? 'Enabled' : 'Disabled'}</span>
              </div>
            </div>
      ...
      <div className="mb-6">
        ...
        <AdminCard className="p-5">
          {stats.dailyData.length === 0 ? (
            <p className="text-sm text-neutral-400">No unlock data yet.</p>
          ) : (
              ...
              {stats.dailyData.map(([date, count]) => {
                ...
                return (
                  <div key={date} className="flex items-center gap-3">
                    <span className="w-24 shrink-0 text-xs text-neutral-500">{date}</span>
