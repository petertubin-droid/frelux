      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1">
          <AdminCard className="space-y-4">
            <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500">AI Action</h2>
              ...
              {actions.map((a) => {
                ...
                return (
                  <button key={a.value} type="button" onClick={() => setAction(a.value)}
                    ...
                    <div>
                      <p className={classNames('text-sm font-semibold', selected ? 'text-brand-purple' : 'text-brand-navy')}>{a.label}</p>
        ...
        <div className="space-y-6 lg:col-span-2">
          <AdminCard className="space-y-4">
            <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500">Input</h2>
          ...
          {result && (
            <AdminCard className="space-y-3">
              <div className="flex items-center justify-between">
                <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500">Result</h2>
              ...
              <div className="max-h-[500px] overflow-y-auto rounded-lg border border-neutral-200 bg-neutral-50 p-4">
                <pre className="whitespace-pre-wrap font-sans text-sm leading-relaxed text-neutral-700">{result}</pre>
              </div>
            </AdminCard>
          )}
        </div>
