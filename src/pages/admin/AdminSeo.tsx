    ...
    <>
      ...
      <AdminCard>
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-bold text-brand-navy">Global SEO</h3>
            <p className="mt-1 text-xs text-neutral-500">Site wide SEO configuration is managed through site settings and individual page meta tags.</p>
          </div>
          ...
          <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-4">
            <h4 className="text-sm font-semibold text-brand-navy">SEO Coverage</h4>
