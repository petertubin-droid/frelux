    ...
    return (
      <>
        <AdminHeader
          ...
          subtitle="Premium building photo estimation feature."
        />
        <StateMessage
          type="loading"
          title="Loading…"
      ...
      {stats && (
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <StatCard
            ...
            value={stats.total_estimates}
          />
          <StatCard
            icon={TrendingUp}
            label="Today's Estimates"
            value={stats.today_estimates}
          />
          <StatCard
            icon={Users}
            label="Unique Users"
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-neutral-50">
            ...
            <Toggle
              ...
              onChange={(v) =>
                setConfig((prev) => ({ ...prev, estimation_enabled: v }))
              }
            />
          </div>
          ...
          <div>
            ...
            <AdminSelect
              ...
              onChange={(e) =>
                setConfig((prev) => ({
                  ...prev,
                  estimation_access_mode: e.target
            ...
            >
              ...
              <option value="rewarded">
                Rewarded (free uses, then watch ad)
              </option>
          ...
          {/* Daily free uses */}
          {(config.estimation_access_mode === "free" ||
            ...
            <div>
              ...
              <AdminInput
                ...
                onChange={(e) =>
                  setConfig((prev) => ({
                    ...prev,
                    estimation_daily_free_uses: Math.max(
                      0,
                ...
                <div>
                  ...
                  <AdminInput
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({
                        ...prev,
                        estimation_paid_price: Math.max(
                          0,
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-neutral-50">
            ...
            <Toggle
              ...
              onChange={(v) =>
                setConfig((prev) => ({ ...prev, estimation_admin_override: v }))
              }
            />
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            {saved && (
              <span className="text-sm text-green-600 flex items-center gap-1">
                <CheckCircle2 aria-hidden="true" className="w-4 h-4" /> Saved
                successfully
              </span>
            )}
          </div>
