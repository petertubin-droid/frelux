...
const mountedRef = useRef(true);
  ...
  return (
    <>
      <PageHeader eyebrow="Calculate" title="POP Ceiling Calculator" subtitle="Calculate ceiling area, material quantities, and labour for your POP ceiling project." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Calculators', path: '/calculators' }, { label: 'POP Ceiling Calculator' }]} />
