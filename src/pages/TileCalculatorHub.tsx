...
const FAQS = [
  {
    question: "How does the FRELUX tile calculator work?",
    answer:
      "Enter your floor or wall dimensions and select your tile size. The calculator determines the exact number of tiles needed, accounts for waste, recommends boxes, and calculates adhesive and grout requirements.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. The calculator works for both floor and wall tiling projects. Just enter the appropriate dimensions and select your tile size.",
  },
  {
    question: "Does the calculator account for waste?",
    answer:
      "Yes. You can set a waste percentage to account for cuts, breakages, and pattern matching. The calculator includes waste tiles in the total recommendation.",
  },
  {
  ...
  return (
    <>
      ...
      <CalculatorTabs
        ...
        ariaLabel="Tile calculator mode"
      />
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="text-neutral-600 dark:text-neutral-300">
            ...
            and provides adhesive and grout quantities based on the surface area
            and tile type.
          </p>
        </div>
