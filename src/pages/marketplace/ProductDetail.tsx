...
export default function ProductDetail() {
    ...
    if (p) {
      ...
      if (p.category_id) {
        const { data: related } = await supabase
          ...
          .select(
            "id, title, price, currency, images, primary_image_idx, location_city, created_at",
          )
          ...
          .limit(4);
        setRelatedProducts(
          (related ?? []) as unknown as DbMarketplaceProduct[],
        );
      }
    }
  }, [id]);
  ...
  useSeo({
    ...
    description:
      ...
      "Building materials and interior design products on FRELUX Marketplace.",
