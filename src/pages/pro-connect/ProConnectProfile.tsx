              ...
              <div className="mt-3 flex flex-wrap items-start gap-2 text-sm text-neutral-500 dark:text-neutral-500">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {locations.slice(0, 5).map((l, i) => (
                    <span
                      key={i}
                      className="rounded-md bg-neutral-100 px-2 py-0.5 text-xs dark:bg-white/5"
                    >
        ...
        <section className="mt-6">
          ...
          <div className="space-y-2">
            {credentials.map((cred) => (
              <div
                key={cred.id}
                className="flex items-center justify-between rounded-xl border border-neutral-200 bg-white px-4 py-3 dark:border-white/5 dark:bg-brand-navy-mid"
              >
                <div>
        ...
        <section className="mt-8">
          ...
          <div className="flex flex-wrap gap-2">
            {services.map((s) => (
              <span
                key={s.id}
                className="rounded-lg border border-neutral-200 bg-white px-4 py-2 text-sm text-neutral-700 dark:border-white/10 dark:bg-brand-navy-mid dark:text-neutral-200"
              >
                {s.name}
              </span>
            ))}
              ...
              item.image_urls.map((url, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                    <p className="absolute bottom-2 left-2 right-2 text-left text-xs font-medium text-white">
                      {item.title}
                    </p>
                  </div>
                </button>
              ...
              >
                ...
                {review.professional_response && (
                  <div className="mt-4 rounded-lg bg-neutral-50 p-4 dark:bg-white/5">
                    <p className="mb-1 text-xs font-medium text-neutral-500 dark:text-neutral-500">
...
function ReportModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-2xl bg-white p-6 dark:bg-brand-navy-mid"
