...
export default function FinishingCalculatorHub() {
  ...
  useSeo({
    ...
    ogType: 'website',
    keywords: 'finishing calculator, tyrolene estimator, grafitex calculator, exterior finishing Nigeria, wall finishing material calculator',
    structuredDataArray: [
      {
        '@context': 'https://schema.org',
        '@type': 'WebApplication',
        name: 'FRELUX Finishing Calculator',
        description: 'Compare Painting, Tyrolene, and Grafitex finishes. Detailed Tyrolene estimator with partition-based material calculations.',
        url: 'https://freluxtools.netlify.app/finish-estimator',
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Finishing Calculator', 'item': 'https://freluxtools.netlify.app/finish-estimator' }
        ]
      },
      {
        '@context': 'https://schema.org',
  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Calculators', path: '/calculators' }, { label: 'Finishing Calculator' }]}
      />
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="text-neutral-600 dark:text-neutral-300">
            This methodology is preserved exactly in the Tyrolene Estimator mode and has not been replaced with
            generic formulas.
          </p>
        </div>
