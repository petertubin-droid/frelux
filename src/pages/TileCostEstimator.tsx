...
export default function TileCostEstimator() {
  ...
  if (loading) {
    return (
      <>
        <PageHeader eyebrow="Estimate" title="Tile Cost Estimator" subtitle="Estimate material and labour costs for your tile installation." breadcrumbs={[{ label: 'Tile Cost Estimator' }]} />
  ...
  return (
    <>
      <PageHeader eyebrow="Estimate" title="Tile Cost Estimator" subtitle="Estimate tile, adhesive, grout, and labour costs for your tiling project." breadcrumbs={[{ label: 'Tile Cost Estimator' }]} />
