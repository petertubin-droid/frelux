...
describe('Different Spaces Remain Independent', () => {
  it('bedroom and kitchen have different areas', () => {
    const bedroom = calculateSpace(createSpace({
      name: 'Bedroom',
      type: 'bedroom',
    ...
    const kitchen = calculateSpace(createSpace({
      name: 'Kitchen',
      type: 'kitchen',
  ...
  it('bathroom with 2 quantity is separate from bedroom with 2 quantity', () => {
    const bathroom = calculateSpace(createSpace({
      name: 'Bathroom',
      type: 'bathroom',
      length: 6, width: 8, height: 8,
      unit: 'feet',
      quantity: 2,
      surfaceType: 'wall',
    }));
...
describe('Openings (Doors and Windows)', () => {
  it('deducts a door from wall area', () => {
    ...
    const spaceWithDoor = createSpace({
      ...spaceNoOpening,
      openings: [createOpening({ type: 'door', width: 3, height: 7, count: 1, unit: 'feet' })],
    });
  ...
  it('deducts multiple openings', () => {
    const space = createSpace({
      ...
      surfaceType: 'wall',
      openings: [
        createOpening({ type: 'door', width: 3, height: 7, count: 1, unit: 'feet' }),
        createOpening({ type: 'window', width: 4, height: 4, count: 2, unit: 'feet' }),
      ],
    });
    const result = calculateSpace(space);
...
describe('Ceiling Inclusion', () => {
  it('adds ceiling area when includeCeiling is true', () => {
    const withoutCeiling = calculateSpace(createSpace({
      name: 'Room',
      type: 'bedroom',
      length: 12, width: 12, height: 10,
      unit: 'feet',
    ...
    const withCeiling = calculateSpace(createSpace({
      name: 'Room',
      type: 'bedroom',
      length: 12, width: 12, height: 10,
      unit: 'feet',
...
describe('Space Grouping', () => {
  it('groups spaces by type', () => {
    const spaces: Space[] = [
      createSpace({ name: 'Bedroom 1', type: 'bedroom', length: 12, width: 12, height: 10, unit: 'feet', surfaceType: 'wall' }),
      createSpace({ name: 'Bedroom 2', type: 'bedroom', length: 10, width: 10, height: 10, unit: 'feet', surfaceType: 'wall' }),
      createSpace({ name: 'Kitchen', type: 'kitchen', length: 10, width: 12, height: 10, unit: 'feet', surfaceType: 'wall' }),
      createSpace({ name: 'Bathroom', type: 'bathroom', length: 6, width: 8, height: 8, unit: 'feet', surfaceType: 'wall' }),
    ];
...
describe('Space Collection', () => {
  it('calculates total area for a collection of spaces', () => {
    const collection = createSpaceCollection('3-Bedroom House', 'feet', [
      createSpace({ name: 'Master Bedroom', type: 'bedroom', length: 12, width: 12, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
      createSpace({ name: 'Other Bedrooms', type: 'bedroom', length: 10, width: 10, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 2 }),
      createSpace({ name: 'Kitchen', type: 'kitchen', length: 10, width: 12, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
      createSpace({ name: 'Bathrooms', type: 'bathroom', length: 6, width: 8, height: 8, unit: 'feet', surfaceType: 'wall', quantity: 2 }),
      createSpace({ name: 'Corridor', type: 'corridor', length: 20, width: 4, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
    ]);
  ...
  it('groups correctly: 2 identical bedrooms + 1 different bedroom', () => {
    const collection = createSpaceCollection('Test House', 'feet', [
      createSpace({ name: 'Bedroom A', type: 'bedroom', length: 12, width: 12, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 2 }),
      createSpace({ name: 'Bedroom B', type: 'bedroom', length: 14, width: 14, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
    ]);
    ...
    const bedroomA = bedroomGroup!.spaceResults.find((r) => r.name === 'Bedroom A')!;
    ...
    const bedroomB = bedroomGroup!.spaceResults.find((r) => r.name === 'Bedroom B')!;
...
describe('Bridge to Existing Measurement System', () => {
  it('converts a space to a measurement entry', () => {
    const space = createSpace({
      ...
      surfaceType: 'wall',
      finishType: 'paint',
      openings: [createOpening({ type: 'door', width: 3, height: 7, count: 1 })],
    });
  ...
  it('converts a space collection to a measurement project', () => {
    const collection = createSpaceCollection('Test', 'feet', [
      createSpace({ name: 'Room 1', type: 'bedroom', length: 12, width: 12, height: 10, unit: 'feet', surfaceType: 'wall' }),
      createSpace({ name: 'Room 2', type: 'kitchen', length: 10, width: 12, height: 10, unit: 'feet', surfaceType: 'wall' }),
    ]);
...
describe('Space Summary', () => {
  it('generates a summary by type', () => {
    const collection = createSpaceCollection('Test', 'feet', [
      createSpace({ name: 'Bedroom 1', type: 'bedroom', length: 12, width: 12, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
      createSpace({ name: 'Bedroom 2', type: 'bedroom', length: 10, width: 10, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 2 }),
      createSpace({ name: 'Kitchen', type: 'kitchen', length: 10, width: 12, height: 10, unit: 'feet', surfaceType: 'wall', quantity: 1 }),
    ]);
...
describe('Waste Margin', () => {
  it('applies waste margin to space area', () => {
    const noWaste = calculateSpace(createSpace({
      name: 'Room',
      type: 'bedroom',
      length: 12, width: 12, height: 10,
      unit: 'feet',
    ...
    const withWaste = calculateSpace(createSpace({
      name: 'Room',
      type: 'bedroom',
      length: 12, width: 12, height: 10,
      unit: 'feet',
