...
describe("Feature 16: Plan → Space Engine Integration", () => {
  ...
  describe("User review operations", () => {
    ...
    it("edits a detected room and tracks corrections", () => {
      ...
      const edited = editDetectedRoom(room, {
        length: 14,
        name: "Master Bedroom",
      });
  ...
  describe("Batch operations", () => {
    it("confirms all rooms", () => {
      const r1 = createDetectedRoom({
        name: "A",
        spaceType: "bedroom",
        length: 10,
        unit: "feet",
      });
      const r2 = createDetectedRoom({
        name: "B",
        spaceType: "kitchen",
        length: 12,
        unit: "feet",
      ...
      expect(
        confirmed.rooms.every((r) => r.verificationState === "user_verified"),
      ).toBe(true);
  ...
  describe("Detection summary", () => {
    it("returns correct summary counts", () => {
      ...
      const detection = createPlanDetectionResult({
        planReference: "p1",
        rooms: [confirmed1, edited2, rejected3],
        detectedUnit: "feet",
      });
