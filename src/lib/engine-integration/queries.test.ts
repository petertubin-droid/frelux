...
describe("queries (supabase not configured)", () => {
  ...
  it("upsertMaterialProfile does not throw", async () => {
    await expect(
      upsertMaterialProfile({ material_key: "test" } as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("toggleMaterialProfileActive does not throw", async () => {
    await expect(
      toggleMaterialProfileActive("id", true),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertRoofMaterial does not throw", async () => {
    await expect(
      upsertRoofMaterial({ material_key: "test" } as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertRoofSection does not throw", async () => {
    await expect(
      upsertRoofSection({ section_key: "test" } as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertWasteConfig does not throw", async () => {
    await expect(
      upsertWasteConfig({} as unknown as never),
    ).resolves.not.toThrow();
  });
  it("updateWasteConfig does not throw", async () => {
    await expect(
      updateWasteConfig("id", {} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("updateAiVerificationState does not throw", async () => {
    await expect(
      updateAiVerificationState("id", "verified" as unknown as never),
    ).resolves.not.toThrow();
  });
  it("createAiVerification does not throw", async () => {
    await expect(
      createAiVerification({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertRuleMetadata does not throw", async () => {
    await expect(
      upsertRuleMetadata({ rule_id: "rule_1" } as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertEngineSetting does not throw", async () => {
    await expect(
      upsertEngineSetting({ setting_key: "key" } as unknown as never),
    ).resolves.not.toThrow();
  });
