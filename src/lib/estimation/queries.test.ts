...
describe("queries (supabase not configured)", () => {
  it("fetchEstimationUnits does not throw", async () => {
    await expect(fetchEstimationUnits({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateEstimationUnit does not throw", async () => {
    await expect(updateEstimationUnit({} as any)).resolves.not.toThrow();
  });
  it("deleteEstimationUnit does not throw", async () => {
    await expect(deleteEstimationUnit({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimationProducts does not throw", async () => {
    await expect(fetchEstimationProducts({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimationProduct does not throw", async () => {
    await expect(fetchEstimationProduct({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateEstimationProduct does not throw", async () => {
    await expect(updateEstimationProduct({} as any)).resolves.not.toThrow();
  });
  it("deleteEstimationProduct does not throw", async () => {
    await expect(deleteEstimationProduct({} as any)).resolves.not.toThrow();
  });
  it("fetchProductQualityLevels does not throw", async () => {
    await expect(fetchProductQualityLevels({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateProductQualityLevel does not throw", async () => {
    await expect(updateProductQualityLevel({} as any)).resolves.not.toThrow();
  });
  it("deleteProductQualityLevel does not throw", async () => {
    await expect(deleteProductQualityLevel({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimationMaterials does not throw", async () => {
    await expect(fetchEstimationMaterials({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateEstimationMaterial does not throw", async () => {
    await expect(updateEstimationMaterial({} as any)).resolves.not.toThrow();
  });
  it("deleteEstimationMaterial does not throw", async () => {
    await expect(deleteEstimationMaterial({} as any)).resolves.not.toThrow();
  });
  it("fetchPackSizes does not throw", async () => {
    await expect(fetchPackSizes({} as any)).resolves.not.toThrow();
  });
  ...
  it("updatePackSize does not throw", async () => {
    await expect(updatePackSize({} as any)).resolves.not.toThrow();
  });
  it("deletePackSize does not throw", async () => {
    await expect(deletePackSize({} as any)).resolves.not.toThrow();
  });
  it("fetchActivePrice does not throw", async () => {
    await expect(fetchActivePrice({} as any)).resolves.not.toThrow();
  });
  it("fetchPriceHistory does not throw", async () => {
    await expect(fetchPriceHistory({} as any)).resolves.not.toThrow();
  });
  ...
  it("fetchAllPrices does not throw", async () => {
    await expect(fetchAllPrices({} as any)).resolves.not.toThrow();
  });
  it("fetchCalcRules does not throw", async () => {
    await expect(fetchCalcRules({} as any)).resolves.not.toThrow();
  });
  it("fetchCalcRule does not throw", async () => {
    await expect(fetchCalcRule({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateCalcRule does not throw", async () => {
    await expect(updateCalcRule({} as any)).resolves.not.toThrow();
  });
  it("deleteCalcRule does not throw", async () => {
    await expect(deleteCalcRule({} as any)).resolves.not.toThrow();
  });
  it("fetchCalcVersions does not throw", async () => {
    await expect(fetchCalcVersions({} as any)).resolves.not.toThrow();
  });
  it("fetchActiveCalcVersion does not throw", async () => {
    await expect(fetchActiveCalcVersion({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateCalcVersion does not throw", async () => {
    await expect(updateCalcVersion({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimates does not throw", async () => {
    await expect(fetchEstimates({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimate does not throw", async () => {
    await expect(fetchEstimate({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimateByRef does not throw", async () => {
    await expect(fetchEstimateByRef({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateEstimate does not throw", async () => {
    await expect(updateEstimate({} as any)).resolves.not.toThrow();
  });
  it("deleteEstimate does not throw", async () => {
    await expect(deleteEstimate({} as any)).resolves.not.toThrow();
  });
  it("fetchEstimateItems does not throw", async () => {
    await expect(fetchEstimateItems({} as any)).resolves.not.toThrow();
  });
  ...
  it("updateEstimateItem does not throw", async () => {
    await expect(updateEstimateItem({} as any)).resolves.not.toThrow();
  });
  it("deleteEstimateItem does not throw", async () => {
    await expect(deleteEstimateItem({} as any)).resolves.not.toThrow();
  });
  it("fetchAdjustments does not throw", async () => {
    await expect(fetchAdjustments({} as any)).resolves.not.toThrow();
  });
  ...
  it("fetchAuditLog does not throw", async () => {
    await expect(fetchAuditLog({} as any)).resolves.not.toThrow();
  });
  ...
  it("fetchColourConditions does not throw", async () => {
    await expect(fetchColourConditions({} as any)).resolves.not.toThrow();
  });
  it("fetchSurfaceConditions does not throw", async () => {
    await expect(fetchSurfaceConditions({} as any)).resolves.not.toThrow();
  });
});
