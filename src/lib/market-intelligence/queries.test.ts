...
describe("queries (supabase not configured)", () => {
  ...
  it("upsertProvider does not throw", async () => {
    await expect(upsertProvider({} as unknown as never)).resolves.not.toThrow();
  });
  ...
  it("upsertSource does not throw", async () => {
    await expect(upsertSource({} as unknown as never)).resolves.not.toThrow();
  });
  ...
  it("upsertProductAlias does not throw", async () => {
    await expect(
      upsertProductAlias({} as unknown as never),
  ...
  it("insertObservation does not throw", async () => {
    await expect(
      insertObservation({} as unknown as never),
    ).resolves.not.toThrow();
  });
  it("updateObservationStatus does not throw", async () => {
    await expect(
      updateObservationStatus("id", "approved" as unknown as never),
    ).resolves.not.toThrow();
  });
  it("setObservationFreshness does not throw", async () => {
    await expect(
      setObservationFreshness("id", "fresh" as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertApprovedPrice does not throw", async () => {
    await expect(
      upsertApprovedPrice({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("insertCrawlLog does not throw", async () => {
    await expect(
      insertCrawlLog("crawl_started", "test"),
    ).resolves.not.toThrow();
  });
  ...
  it("resolveAnomaly does not throw", async () => {
    await expect(
      resolveAnomaly("id", "resolved", "user"),
    ).resolves.not.toThrow();
  });
  it("insertAnomalyFlag does not throw", async () => {
    await expect(
      insertAnomalyFlag("obs1", "price_deviation", {} as unknown as never),
    ).resolves.not.toThrow();
  });
