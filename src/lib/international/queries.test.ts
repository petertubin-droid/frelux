...
describe("queries (supabase not configured)", () => {
  ...
  it("upsertMarketProfile does not throw", async () => {
    await expect(
      upsertMarketProfile({ country_code: "NG" } as unknown as never),
  ...
  it("upsertMaterialRule does not throw", async () => {
    await expect(
      upsertMaterialRule({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertMarketProduct does not throw", async () => {
    await expect(
      upsertMarketProduct({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertMarketPricing does not throw", async () => {
    await expect(
      upsertMarketPricing({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertCalculatorConfig does not throw", async () => {
    await expect(
      upsertCalculatorConfig({} as unknown as never),
    ).resolves.not.toThrow();
  });
  ...
  it("upsertUserMarketPreference does not throw", async () => {
    await expect(
      upsertUserMarketPreference("user_1", {} as unknown as never),
    ).resolves.not.toThrow();
  });
});
