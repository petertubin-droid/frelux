      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div className="p-6">
          ...
          {isUnlocked && expiresAt && (
            <div className="mt-4 flex items-center gap-2 rounded-lg border border-accent-green/30 bg-accent-green/10 p-3 text-sm text-neutral-700">
          ...
          {adLoading && (
            <div className="mt-6 flex flex-col items-center gap-3 py-4">
              ...
              <p className="text-sm font-semibold text-neutral-600">Playing ad…</p>
              <p className="text-xs text-neutral-400">Please keep this tab open while the ad plays.</p>
            </div>
          )}
