            ...
            return (
              ...
              >
                ...
                <div className="relative h-full rounded-2xl border border-border/60 bg-card p-7 transition-all duration-300 hover:border-brand-purple/20 hover:shadow-premium dark:border-white/5 dark:bg-card dark:hover:border-brand-purple/30">
                  ...
                  <h3 className="mt-5 font-display text-lg font-bold text-foreground dark:text-primary-foreground">{step.title}</h3>
                  <p className="mt-2.5 text-sm leading-relaxed text-muted-foreground dark:text-muted-foreground">{step.description}</p>
                </div>
              </div>
            );
          })}
