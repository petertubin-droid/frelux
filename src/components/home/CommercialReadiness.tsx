...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "Save your calculations and come back to them anytime. Share a link with your contractor or print a PDF for your records.",
    to: "/my-projects",
  ...
  },
  {
    ...
    description:
      "Compare painting, Tyrolene, and Grafitex finishes side by side. Understand material requirements for each finishing approach.",
    to: "/finish-estimator",
        ...
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-brand-purple/15 bg-primary/5 p-8 sm:flex-row">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground dark:text-muted-foreground">
              All calculators are free. No sign-up required to start
              calculating.
            </p>
          </div>
          <Link
