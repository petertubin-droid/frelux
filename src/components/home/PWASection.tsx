...
export default function PWASection() {
  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy py-20 text-primary-foreground sm:py-24 bg-noise">
      {/* Grid pattern */}
      <div
        className="pointer-events-none absolute inset-0 bg-grid-dark opacity-30"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute left-1/3 top-0 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-primary/15 blur-[140px] animate-gradient-pulse"
        aria-hidden="true"
      />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-lg leading-relaxed text-primary-foreground/55 text-balance">
              Access every FRELUX calculator from your phone, on site, in the
              store, wherever you are. Install it as an app on supported
              devices.
            </p>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-foreground/45">
                    Saved estimates and recent calculations are available
                    without internet
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-foreground/45">
                    Clean, readable interface that works on any Android or iOS
                    device
                  </p>
                </div>
              </div>
          ...
          >
            <div className="relative mx-auto w-[260px]">
                ...
                <div className="h-[480px] overflow-y-auto p-4 pt-8 scrollbar-hide">
                  ...
                  <div className="rounded-xl border border-white/5 bg-white/[0.02] p-4">
                    ...
                    <div className="mt-3 space-y-2">
                      <div className="flex gap-2">
                        <div className="flex-1 rounded-lg bg-white/5 px-3 py-2">
                          <p className="text-[9px] text-primary-foreground/30">
                            Length
                          </p>
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1 rounded-lg bg-primary/10 px-3 py-2">
                          <p className="text-[9px] text-brand-purple-light/50">
                            Coats
                          </p>
                          <p className="text-xs font-bold text-brand-purple-light">
                            2
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mt-3 rounded-lg bg-primary/10 p-3">
                      <p className="text-[9px] font-semibold uppercase tracking-wide text-brand-purple-light/60">
                        Paint needed
                      </p>
                  ...
                  <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div className="rounded-lg border border-white/5 bg-white/[0.02] p-2.5 text-center">
                      ...
                      <p className="mt-1 text-[9px] text-primary-foreground/50">
                        Screeding
                      </p>
                    </div>
                    <div className="rounded-lg border border-white/5 bg-white/[0.02] p-2.5 text-center">
              ...
              <div
                className="absolute -right-8 top-20 rounded-xl bg-card p-3 shadow-premium-lg animate-float-smooth dark:bg-card dark:border dark:border-white/10"
                style={{ width: "180px" }}
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-foreground dark:text-primary-foreground">
                      Install FRELUX
                    </p>
                    <p className="text-[9px] text-muted-foreground dark:text-primary-foreground/40">
                      Add to home screen
                    </p>
                  </div>
                </div>
