      ...
      <Container className="relative grid items-center gap-12 py-24 sm:py-28 lg:grid-cols-2 lg:gap-20 lg:py-36">
        ...
        <div className="animate-fade-in-up">
          ...
          <h1 className="mt-7 font-display text-4xl font-bold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.75rem] text-balance">
            ...
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-brand-purple-light via-white to-brand-purple-light bg-clip-text text-transparent">
                Paint Project
              </span>
              ...
              {heroSteps.map((step, i) => {
                ...
                return (
                  <div key={step.label} className="flex items-center gap-2">
                    <Link
                      to={step.to}
                      className="inline-flex items-center gap-1.5 rounded-lg border border-white/8 bg-white/[0.03] px-3.5 py-2 text-xs font-medium text-white/60 transition-all hover:border-white/15 hover:text-white hover:bg-white/5"
                    >
        ...
        <div className="relative hidden lg:block animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
          <div className="relative mx-auto max-w-md">
            ...
            <div className="absolute -top-4 right-12 rounded-xl bg-brand-purple px-3.5 py-2.5 shadow-lg shadow-brand-purple/30">
