...
import { 
  ...
  BookOpen, Users, Search, Plug, ShieldCheck, Sun, Moon, HardHat, Mail, AlertTriangle, Package, Calendar, FileSignature, Type, Factory, Building2, Briefcase, ShoppingBag, Cpu, MapPin, Camera, Gem, TrendingUp, Coins, Film,
} from 'lucide-react';
...
const navModules: NavModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Credits & Rewarded Ads', to: '/admin/credits-ads', icon: Coins },
    ],
  },
  {
    heading: 'Users',
