      ...
      {state !== 'available' && (
        <div className="space-y-3">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-neutral-200 pl-9 pr-3 py-2 text-sm"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-brand-purple px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-purple/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loadingImagery ? (
              <>
                <Loader2 aria-hidden="true" className="w-4 h-4 animate-spin" />
        ...
        <div className="space-y-3">
          <div className="relative rounded-lg overflow-hidden border border-neutral-200">
            ...
            <button
              ...
              className="absolute top-2 right-2 flex items-center gap-1 rounded-md bg-black/50 backdrop-blur px-2 py-1 text-xs text-white hover:bg-black/70"
            >
              <X className="w-3 h-3" />
              Clear
            </button>
