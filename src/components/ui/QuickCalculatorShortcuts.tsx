...
const shortcuts = [
  ...
  },
  {
    ...
    icon: Calculator,
    description: "Estimate Painting, Tyrolene and Grafitex finishes",
  },
  {
    to: "/pop-ceiling-calculator",
    label: "POP Ceiling",
    icon: Layers,
    description: "Estimate POP ceiling materials",
  },
  {
    to: "/tile-calculator",
    label: "Tile Calculator",
    icon: Grid3x3,
    description: "Plan tile layout and materials",
  },
];
    ...
    <section className="border-y border-border/60 bg-muted/50 py-10 sm:py-12 dark:border-white/5 dark:bg-card">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <h2 className="font-display text-xl font-bold text-foreground sm:text-2xl dark:text-primary-foreground">
              Quick Access
            </h2>
            <p className="mt-1 text-sm text-muted-foreground dark:text-muted-foreground">
              Jump straight to the most-used calculators
            </p>
          </div>
          <Link
            to="/my-projects/"
            className="group hidden items-center gap-1 text-sm font-semibold text-brand-purple transition-colors hover:text-brand-purple-dark sm:inline-flex dark:text-brand-purple-lighter dark:hover:text-brand-purple"
          >
            My Projects{" "}
            <ArrowRight
              aria-hidden="true"
