...
export default function RelatedToolsLinks({ compact = false }: { compact?: boolean }) {
    ...
    return (
      <div className="mt-8 flex flex-wrap items-center gap-3">
        <Link
          ...
          className="related-tool-card inline-flex items-center gap-1.5 rounded-lg border border-neutral-200 px-3 py-2 text-xs font-medium text-neutral-600 dark:border-white/10 dark:text-neutral-300"
        >
  ...
  return (
    <div className="mt-10 grid gap-4 sm:grid-cols-2">
      <Link
        to="/build-to-roof-estimator"
        className="related-tool-card group flex items-center gap-4 rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-brand-navy-mid"
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-500">Estimate a full building project from foundation to roof.</p>
        </div>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-500">Upload a photo and get an AI-powered estimate.</p>
        </div>
