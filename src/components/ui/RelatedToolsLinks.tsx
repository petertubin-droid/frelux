...
export default function RelatedToolsLinks({
  compact = false,
}: {
  compact?: boolean;
}) {
  ...
  return (
    <div className="mt-10 grid gap-4 sm:grid-cols-2">
      ...
      >
        ...
        <ArrowRight
          aria-hidden="true"
          className="h-4 w-4 text-muted-foreground/80 transition-transform group-hover:translate-x-1 group-hover:text-brand-purple"
        />
      </Link>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-muted-foreground dark:text-muted-foreground">
            Upload a photo and get an AI-powered estimate.
          </p>
        </div>
        <ArrowRight
          aria-hidden="true"
          className="h-4 w-4 text-muted-foreground/80 transition-transform group-hover:translate-x-1 group-hover:text-accent-green"
        />
      </Link>
    </div>
  );
