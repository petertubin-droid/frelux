...
export function VoiceInputButton({ onResult, label, compact = true }: VoiceInputButtonProps) {
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        className={classNames(
          ...
          isListening
            ...
            : 'border-neutral-200 text-neutral-400 hover:border-brand-purple/30 hover:text-brand-purple dark:border-neutral-700 dark:text-neutral-500',
        )}
      ...
      {feedback && (
        <span className="text-xs text-neutral-500 dark:text-neutral-400">{feedback}</span>
      )}
      {error && (
