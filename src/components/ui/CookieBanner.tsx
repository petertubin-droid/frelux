              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h2
                    ...
                    className="text-base font-semibold text-foreground dark:text-muted-foreground/30 tracking-tight"
                  >
                    Cookie Preferences
                  </h2>
                  <p className="mt-1 text-sm text-muted-foreground dark:text-muted-foreground leading-relaxed">
                    We use cookies to power essential features, improve the site
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-medium text-foreground dark:text-muted-foreground/40">
                                {label}
                              </span>
                              {required && (
