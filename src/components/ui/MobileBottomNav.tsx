...
import { Home, Calculator, ShoppingBag, FolderOpen, Trophy } from 'lucide-react';
          ...
          return (
            <Link
              ...
              className={classNames(
                ...
                active ? 'text-brand-purple dark:text-brand-purple-lighter' : 'text-muted-foreground dark:text-muted-foreground',
              )}
            >
              <span className={classNames(
                ...
                {item.badge !== undefined && item.badge > 0 && (
                  <span className="absolute -right-1 -top-1 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-amber-400 px-1 text-[8px] font-bold text-primary-foreground">
                    {item.badge}
                  </span>
                )}
              </span>
