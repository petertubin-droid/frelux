...
// Adsterra helpers (pure functions + per-page density state) live in
...
export default function AdSlot({
  ...
  useEffect(() => {
    ...
    // slotKey is a real dependency (adDebug labels + zone config);
    // every injection branch is guarded by a presence check, so a
