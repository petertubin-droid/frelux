...
export default function CalculatorNearMe({
  ...
  return (
    <div className="rounded-xl border border-brand-purple/20 bg-primary/5 p-4 dark:bg-primary/10">
      ...
      {hasLocation && (
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <span className="inline-flex items-center gap-1 text-xs font-medium text-muted-foreground dark:text-muted-foreground/80">
